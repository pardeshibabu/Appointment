...
public class StuApptProfList_AdapterClass extends ArrayAdapter<RegisterSaveData> {

    private Activity context;
    private List<RegisterSaveData> professorList;

    public StuApptProfList_AdapterClass(Activity context, List<RegisterSaveData> professorList) {
